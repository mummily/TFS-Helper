...
namespace TFS_Helper
{
    ...
    {
        public static string m_strDataSource = "127.0.0.1";
        public static string m_strDatabase = "tfs_helper";
        public static string m_strUser = "root";
        public static string m_strPassword = "hollysys";
        ...
        public static string GetConnectString()
        {
            return string.Format("server={0};uid={1};pwd={2};database={3}",
               MySqlSetting.m_strDataSource,
               MySqlSetting.m_strUser,
               MySqlSetting.m_strPassword,
               MySqlSetting.m_strDatabase);
        }
    }
    ...
    public abstract class SQLHelper
    {
        ...
        public static int ExecuteNonQuery(string cmdText, CommandType cmdType = CommandType.Text, params MySqlParameter[] commandParameters)
        {
            ...
            string connectionString = MySqlSetting.GetConnectString();
